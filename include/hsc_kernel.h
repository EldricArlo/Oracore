...
#define HSC_ERROR_OUTPUT_BUFFER_TOO_SMALL         -9 // Provided output buffer is too small for the result.
...
// Added public_key_max_len for safety.
...
// encrypted_output_max_len: Size of the output buffer. Must be at least HSC_MAX_ENCAPSULATED_KEY_SIZE.
...
// decrypted_output_max_len: Size of the output buffer. Should be at least HSC_SESSION_KEY_BYTES.
...
// Added decrypted_message_max_len.
...
// ciphertext_max_len:  Size of ciphertext buffer.
// tag_out:             Buffer for the authentication tag.
// tag_max_len:         Size of tag buffer.
// nonce_out:           Buffer for the generated nonce.
// nonce_max_len:       Size of nonce buffer.

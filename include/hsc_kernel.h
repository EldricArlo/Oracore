...
#define HSC_ERROR_OUTPUT_BUFFER_TOO_SMALL         -9 // [FIX]: Provided output buffer is too small for the result.
...
// [FIX]: Added public_key_max_len for safety.
...
// encrypted_output_max_len: [FIX] Size of the output buffer. Must be at least HSC_MAX_ENCAPSULATED_KEY_SIZE.
// encrypted_output_len:    Pointer to store the actual length of the output.
...
// decrypted_output_max_len: [FIX] Size of the output buffer. Should be at least HSC_SESSION_KEY_BYTES.
...
// [FIX]: Added decrypted_message_max_len.
int hsc_aead_decrypt(unsigned char* decrypted_message,
                     size_t decrypted_message_max_len,
...
// ciphertext_max_len:  [FIX] Size of ciphertext buffer.
// tag_out:             Buffer for the authentication tag.
// tag_max_len:         [FIX] Size of tag buffer.
// nonce_out:           Buffer for the generated nonce.
// nonce_max_len:       [FIX] Size of nonce buffer.
